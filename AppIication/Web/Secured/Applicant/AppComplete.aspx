<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AppComplete.aspx.vb"
    Inherits="Secured_Applicant_AppComplete" MasterPageFile="~/MasterPage/Applicant.master" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                <asp:GridView
                    ...
                    AutoGenerateColumns="False" EmptyDataText="NO TRAINING">

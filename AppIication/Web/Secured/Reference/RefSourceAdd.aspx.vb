...
Partial Class Secured_Reference_RefSourceAdd
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            hfTransId.Value = Session("REF_SOURCE_ID")
    ...
    Protected Sub btnHome_ServerClick(sender As Object, e As EventArgs) Handles btnHome.ServerClick
        Response.Redirect("RefSource.aspx")
    End Sub

    Private Sub flllInfo()

        Dim _clsRefRecord As New clsRefProgramSources

        With _clsRefRecord
            .getRefProgramSources(hfTransId.Value)
    ...
    Private Sub saveRef()
        ...
        Dim _clsRefTrainings As New clsRefProgramSources
        ...
        With _clsRefTrainings
            ...
            .saveRefProgramSources()

            Session("REF_SOURCE_ID") = .transId
        End With

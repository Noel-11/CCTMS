...
Partial Class Secured_Reference_RefEducAttainmentAdd
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            hfTransId.Value = Session("REF_EDUC_ID")
    ...
    Protected Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If thisMsgBox.getModalType = "SAVE" Then
            ...
            Response.Redirect("RefEducAttainmentAdd.aspx")
    ...
    Protected Sub btnHome_ServerClick(sender As Object, e As EventArgs) Handles btnHome.ServerClick
        Response.Redirect("RefEducAttainment.aspx")
    End Sub

    Private Sub flllInfo()

        Dim _clsRefRecord As New clsRefEducAttainment

        With _clsRefRecord
            .getRefEducAttainment(hfTransId.Value)
    ...
    Private Sub saveRef()
        ...
        Dim _clsRefTrainings As New clsRefEducAttainment

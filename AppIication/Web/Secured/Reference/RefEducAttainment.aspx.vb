Imports System.Data
Partial Class Secured_Reference_RefEducAttainment
    ...
    Protected Sub fillGv()
        ...
        Dim _clsRecord As New clsRefEducAttainment

        dt = _clsRecord.browseRefEducAttainment(txtSearch.Text.Trim)
    ...
    Protected Sub cmdGVUpdate(ByVal sender As Object, ByVal e As CommandEventArgs)
        Session("REF_EDUC_ID") = e.CommandArgument.ToString

<%@ Page Title="Trainings" Language="VB" AutoEventWireup="false" CodeFile="RefEducAttainment.aspx.vb"
    Inherits="Secured_Reference_RefEducAttainment" Theme="Skins"
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <h2 class="text-success">Reference Educational Attainments</h2>
                </div>
                ...
                <ContentTemplate>
                    ...
                    <asp:GridView runat="server" ID="_gv" HeaderStyle-Font-Size="14px" CssClass="gridviewGreen table-bordered table-success table-striped table-hover" PageSize="15" EmptyDataText="NO RECORD FOUND"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="description" HeaderText="Description" ItemStyle-Width="40%" ItemStyle-HorizontalAlign="Left" />

Imports System.Data
Partial Class Secured_Reference_RefTrainings
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Session.Remove("REF_TRAINING_ID")
    ...
    Protected Sub fillGv()
        ...
        Dim _clsRecord As New clsRefTrainings

        dt = _clsRecord.browseRefTrainings(txtSearch.Text.Trim)
    ...
    Protected Sub cmdGVUpdate(ByVal sender As Object, ByVal e As CommandEventArgs)
        Session("REF_TRAINING_ID") = e.CommandArgument.ToString

Imports System.Data
Partial Class Secured_TrainingManagement_TrainingTagApplicants
    ...
    Protected Sub fillGv()
        ...
        dt = _clsRecord.browseTraining(txtSearch.Text.Trim)
    ...
    Protected Sub cmdGVUpdate(ByVal sender As Object, ByVal e As CommandEventArgs)
        Session("TRAINING_ID") = e.CommandArgument.ToString
